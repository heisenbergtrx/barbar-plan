          ...
          <div className="bg-neutral-900/50 border border-neutral-800 rounded-lg p-4">
             ...
             <div className="grid grid-cols-1 gap-3 text-[10px]">
               <div className="flex flex-col">
                 ...
                 <span className="text-neutral-500">Haftaiçi likidite bölgeleri.</span>
               </div>
               <div className="flex flex-col">
                 <span className="text-amber-500 font-bold">CONFLUENCE</span> 
                 <span className="text-neutral-500">Kesişim.</span>
               </div>
               <div className="flex flex-col">
                 <span className="text-amber-500 font-bold">PWH / PWL</span> 
                 <span className="text-neutral-500">Önceki haftanın en yüksek/düşük seviyesi (Likidite/Sweep).</span>
               </div>
               <div className="flex flex-col">
                 <span className="text-amber-500 font-bold">EXT. I (TRAP)</span> 
                 <span className="text-neutral-500">TRAP-SFP Dikkat bölgesi.</span>
               </div>
               <div className="flex flex-col">
                 <span className="text-amber-500 font-bold">EXT. II (TREND)</span> 
                 <span className="text-neutral-500">Momentumlu trendde potansiyel direnç bölgesi (Market Vitals şiştiyse).</span>
               </div>
             </div>
          </div>
